...
type FieldsProps = { form: UseFormReturn<Step3Data> };

/** Organization name, specialties, and executive title. */
export function OrganizationFields({ form }: FieldsProps) {
...
/** Job-function picker; Doctor reveals specialty / subspecialty / title. */
export function JobRoleFields({ form }: FieldsProps) {
  const t = useTranslations("auth.signUp");
    ...
    <div className="flex flex-col gap-3 rounded-xl border border-gray-100 p-4">
      ...
      {isDoctor && (
        <div className="flex flex-col gap-4 ps-1">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="doctorSpecialty" className="text-sm text-brand-black">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="professionalTitle" className="text-sm text-brand-black">
            ...
            />
            <p className="text-xs text-gray-400">{t("professionalTitleHint")}</p>
...
/** Main branch address fields. */
export function BranchFields({ form }: FieldsProps) {
  const t = useTranslations("auth.signUp");
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={cn(inputClass, errorInputClass(!!errors.branchName))}
        />
        {fieldError(errors.branchName?.message)}
      </div>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={cn(inputClass, errorInputClass(!!errors.country))}
        />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            {...form.register("city")}
            className={cn(inputClass, errorInputClass(!!errors.city))}
          />
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className={cn(inputClass, errorInputClass(!!errors.governorate))}
          />
          {fieldError(errors.governorate?.message)}
        </div>
      </div>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={cn(inputClass, errorInputClass(!!errors.address))}
        />
