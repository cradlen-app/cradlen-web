...
import financialEn from "@/core/financial/messages/en.json";
import financialAr from "@/core/financial/messages/ar.json";
 ...
 * composing the namespaced slices directly. Keep this in sync with each
 * module's `i18nNamespace` (staff, financial).
 */
const TEST_MESSAGES: Record<string, Record<string, unknown>> = {
  en: { ...enMessages, staff: staffEn, financial: financialEn },
  ar: { ...arMessages, staff: staffAr, financial: financialAr },
};
