...
export default function SelectProfileError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    createLogger("select-profile").error("Route boundary caught an error", {
      error,
      digest: error.digest,
    });
  }, [error]);
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-2xl flex flex-col items-center gap-6 text-center">
          <Image src={LogoIcon} alt="" loading="eager" width={72} height={72} />
